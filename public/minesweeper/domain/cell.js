...
var _Cell_wasMarkedAsBomb, _Cell_wasExposed, _CellInBoard_cellsAround, _CellInBoard_totalBombsAround;
/*
lógica de negocio:
...
export class Cell {
    constructor(x, y, id, isBomb) {
        ...
        // las celdas marcadas como posible bomba no pueden ser expuestas
        this.expose = () => {
            if (!__classPrivateFieldGet(this, _Cell_wasMarkedAsBomb, "f") && !__classPrivateFieldGet(this, _Cell_wasExposed, "f") && !this.isBomb) {
                __classPrivateFieldSet(this, _Cell_wasExposed, true, "f");
            }
        };
        this.markAsBomb = () => (__classPrivateFieldSet(this, _Cell_wasMarkedAsBomb, true, "f"));
        this.unCheckAsBomb = () => (__classPrivateFieldSet(this, _Cell_wasMarkedAsBomb, false, "f"));
        this.isExposed = () => __classPrivateFieldGet(this, _Cell_wasExposed, "f");
        this.isMarkAsBomb = () => __classPrivateFieldGet(this, _Cell_wasMarkedAsBomb, "f");
...
export class CellInBoard extends Cell {
    constructor(cell, cellsAround, totalBombsAround) {
        ...
        this.getIdsOfCellsAround = () => __classPrivateFieldGet(this, _CellInBoard_cellsAround, "f");
        this.getTotalBombsAround = () => __classPrivateFieldGet(this, _CellInBoard_totalBombsAround, "f");
        __classPrivateFieldSet(this, _CellInBoard_cellsAround, cellsAround, "f");
        __classPrivateFieldSet(this, _CellInBoard_totalBombsAround, totalBombsAround, "f");
    }
}
_CellInBoard_cellsAround = new WeakMap(), _CellInBoard_totalBombsAround = new WeakMap();
